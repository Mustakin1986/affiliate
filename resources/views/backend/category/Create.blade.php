                        ...
                        <form class="forms-sample" action="{{ route('category.store') }}" method="POST"
                            ...
                            <div class="col-md-8 float-left">
                                ...
                                <div class="col-md-8 float-lef d-flex">
                                    <div class="form-group col-md-6 m-1 ">
                                        <select name="is_parent" class="form-control form-control-sm text-cente"
                                            id="exampleFormControlSelect3">
                                            <option class="text-center" value="">--Select--</option>
                                            <option class="text-center" value="1"
                                                {{ old('condition') == 'is_parent' ? 'selectrd' : '' }}>Yes</option>
                                            <option class="text-center" value="2"
                                                {{ old('condition') == 'is_parent' ? 'selectrd' : '' }}>No</option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-floating col-md-10 ml-3">
                                    <textarea class="form-control" name="summary" rows="20" placeholder="Leave a comment here" id="summary"
