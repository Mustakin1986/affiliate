    ...
    <ul class="nav">
      ...
      <li class="nav-item">
        <a class="nav-link" data-toggle="collapse" href="#category" aria-expanded="false" aria-controls="category">
          ...
          <span class="menu-title ml-auto">Category</span>
          <i class="menu-arrow"></i>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link" data-toggle="collapse" href="#product" aria-expanded="false" aria-controls="product">
          ...
          <span class="menu-title ml-auto">Product</span>
          <i class="menu-arrow"></i>
        </a>
      ...
      {{-- post section --}}
      <li class="nav-item">
        <a class="nav-link" data-toggle="collapse" href="#post_cat" aria-expanded="false" aria-controls="post_cat">
