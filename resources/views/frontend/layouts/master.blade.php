...
<body>
    ...
    <!-- Featured Products Start -->
    <div class="container-fluid pt-5">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Best
                Selling</span></h2>
        <div class="owl-carousel related-carousel">
            <div class="col-lg-6 col-md-3 col-sm-5 pb-1">
            ...
            <div class="col">
                <div class="owl-carousel vendor-carousel">
                    <div class="bg-light p-2">
                        <img src="{{ asset('Frontend/img/vendor-1.jpg') }}" alt="" style="height:90px">
                    </div>
                    <div class="bg-light p-2">
